...
public class DateCalculator {
    ...
    private static By CorrectFrame = By.xpath("//tbody/tr[2]/td[2]/div[1]/label");
    ...
    public void enterData() {
        ...
        ActOn.element(driver, MonthDropDown).setValue(month + "1");
        //Select day from Dropdown
        ActOn.element(driver, DayDropDown).selectValue(day);
        ActOn.element(driver, DayDropDown).setValue(day + "1");
        ...
        //ActOn.element(driver, YearField).setValue("2025");
