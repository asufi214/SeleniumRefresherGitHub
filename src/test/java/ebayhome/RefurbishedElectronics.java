...
//        driver.findElement(UnlockedCheckBox).click();
    ...
    public void verifyRefurbishedIphone(){
        ...
        //Put the expected value '3,465 Results' in string format & use boolean to verify the formattedxpath string is present
        //I manually perform actions to find the results value then update the test before running
        String expectedResult = "3,534 Results";
        String formattedXpath = String.format("/html/body/div[3]/div[3]/div[3]/section[1]/div[1]/div[2]/div/div/h2[text()='3,534 Results']");
