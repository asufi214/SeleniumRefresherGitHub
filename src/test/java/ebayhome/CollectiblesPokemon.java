...
public class CollectiblesPokemon {
    ...
    private final static By GradeLink = By.xpath("//*[@id=\"s0-28-9-0-1[0]-0-0-6-8-4[4]-flyout\"]/button/span[text()='Graded']");
    private final static By GradeYes = By.xpath("//*[@id=\"s0-28-9-0-1[0]-0-0-6-8-4[4]-flyout\"]/div/ul/li[1]/a/span[2]/..");
